...
function AMQPFooter(annotations) {
    ...
    return {
        getValue: function () {
            ...
            var constructor = new DescribedConstructor(map.getCode(), new TLVFixed(AMQPType.SMALL_ULONG, Buffer.from(0x78)));
